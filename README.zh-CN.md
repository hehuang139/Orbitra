...
| **Minecraft**  | 浏览 Mojang 官方 Java 版目录，按 SHA-1 下载、去重、校验、修复和清理；1.2.5 提供受限的 CheerpJ 浏览器试玩     |
...
- [x] 增加 Minecraft: Java Edition 官方版本库，支持发现、下载并校验官方清单仍公开的各版本；1.2.5 可通过 CheerpJ 在浏览器内受限试玩，现代版本仍只提供版本管理。详细范围见 [Minecraft roadmap](docs/roadmaps/minecraft.md) 和 [实现边界](docs/minecraft-support.md)。
